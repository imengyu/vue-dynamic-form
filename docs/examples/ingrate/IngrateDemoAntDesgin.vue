...
const formOptions : IDynamicFormOptions = {
  widgets: {
    'text': makeWidget(markRaw(Input), {}, 'value'),
    'password': makeWidget(markRaw(Input.Password), {}, 'value'),
    'number': makeWidget(markRaw(InputNumber), {}, 'value'),
    'text-area': makeWidget(markRaw(Textarea), {}, 'value'),
    'switch': makeWidget(markRaw(Switch), {}, 'checked'),
    'check-box': makeWidget(markRaw(Checkbox), {}, 'checked'),
    'rate': makeWidget(markRaw(Rate), {}, 'value'),
    'date': makeWidget(markRaw(DatePicker), {}, 'value'),
    'time': makeWidget(markRaw(TimePicker), {}, 'value'),
    'date-time': makeWidget(markRaw(DatePicker), { showTime: true }, 'value'),
